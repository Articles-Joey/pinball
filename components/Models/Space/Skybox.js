...
export function ModelSkyboxSpace(props) {
  const { nodes, materials } = useGLTF('models/Skybox/billions_stars_skybox.glb')
  return (
...
useGLTF.preload('models/Skybox/billions_stars_skybox.glb')
